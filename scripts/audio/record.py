...
from src.config.audio_app_config import AudioAppArgs, AudioAppConfig
from src.app.base_audio_app import BaseAudioApp
from src.audio_device.calibrator_adapter import AudioDeviceCalibratorAdapter
...
from src.models.recorder_adapter import AudioStreamsRecorderAdapter
...
class RecorderApp(BaseAudioApp):
    ...
    def __init__(self, app_config: AudioAppConfig, output_dir: str = "recordings"):
        """
        ...
        """
        logger.debug("Initializing RecorderApp")
...
if __name__ == "__main__":
    ...
    try:
        ...
        app = RecorderApp(app_config=config)
        app.run()
